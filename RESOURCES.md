...
Каталог всех отобранных репозиториев — с разбивкой по назначению, поиском и отметками о пройденном — на странице [репозиториев](https://nurekella.github.io/AboutMe/repos.html).
